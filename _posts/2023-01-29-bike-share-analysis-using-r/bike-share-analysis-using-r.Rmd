...
```{r STEP 2 - Check column name, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
colnames(m1_2022)
colnames(m2_2022)
colnames(m3_2022)
colnames(m4_2022)
...
```{r STEP 2 - Check the data types of column, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
str(m1_2022)
str(m2_2022)
str(m3_2022)
str(m4_2022)
...
```{r STEP 3 - Re-check and clean up data, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r STEP 3 - Inspect the columns data types, eval=TRUE, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
str(all_trips)
```
...
View(member_compare)      #view new dataframe
```
...
To export a summary dataframe into a csv format, here's the code
