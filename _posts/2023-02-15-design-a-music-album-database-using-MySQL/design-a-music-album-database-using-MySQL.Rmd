...
![***Fig. 2.*** New database named **`record_company`**.](step-1-1_create-a-database.png){width="35%"}
...
![***Fig. 3.*** A three tables appear in **`record_company`** database.](step-1-2_design-a-table.png){width="35%"}
...
![***Fig. 4.*** All the bands included.](step-4-1_how-many-band.png){width="35%"}
...
![***Fig. 5.*** The oldest album.](step-4-2_oldest-album.png){width="50%"}
...
![***Fig. 6.*** The list of bands that have at least one album.](step-4-3_bands-one-album.png){width="40%"}
...
![***Fig. 7.*** The list of bands that have no album.](step-4-4_bands-no-album.png){width="40%"}
...
![***Fig. 8.*** The bands with the longest album.](step-4-5_bands-longest-album.png){width="60%"}
...
```{sql STEP 4-6 - Update the album data with no release year, eval=FALSE, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
![***Fig. 9.*** The steps to update a data.](step-4-6_update-album-year.png){width="60%"}
