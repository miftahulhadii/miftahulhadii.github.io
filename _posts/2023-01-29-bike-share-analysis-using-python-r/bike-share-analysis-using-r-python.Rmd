...
-   Data Analysis Process in:
    ...
    -   R scripts → [R Code](https://github.com/miftahulhadii/kaggle-r/blob/main/bike-share-analysis-using-r.rmd)

    -   Python scripts → [Python Code](https://github.com/miftahulhadii/kaggle-python/blob/main/bike-share-analysis-using-python.ipynb)
