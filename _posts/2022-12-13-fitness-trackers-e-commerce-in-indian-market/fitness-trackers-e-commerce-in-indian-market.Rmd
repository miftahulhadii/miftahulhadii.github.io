...
preview: _posts/2022-12-13-fitness-trackers-e-commerce-in-indian-market/fitness-tracker.png
author:
  - name: Miftahul Hadi
date: Dec 6, 2022
categories:
...
```{r Library included, message=FALSE, warning=FALSE, paged.print=FALSE}
library(tidyverse)
library(ggplot2)
library(dplyr)
library(readr)
...
```{r Dataset loaded, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(readr)
...
```{r Top Strap Material: Fitness Band}
...
```{r Top Strap Material: Smartwatches}
...
```{r Battery Life Vs. Rating, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r Mean Selling Price: Smartwatch, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r Mean Selling Price: Fitness Band, message=FALSE, warning=FALSE, paged.print=FALSE}
